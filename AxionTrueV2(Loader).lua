game.StarterGui:SetCore("SendNotification", {
    Title = "Axion Hub Welcome";
    Text = "Plz Join Discord Server";
    Icon = "rbxassetid://115868019459461";
    Duration = 1e5;
	Button1 = "Yes";
	Button2 = "No";
})
...
local Window = Fluent:CreateWindow({
    Title="Axion Hub Blox-Fruits [ Premium ] True V2 https://discord.gg/ZhGqFS5A",
    SubTitle="by _ToBiii", 
    TabWidth=160, 
...
local Tabs = {
    Info=Window:AddTab({ Title="Tab About Hub" }),
    Main=Window:AddTab({ Title="Tab Farm" }),
    Sea=Window:AddTab({ Title="Tab Sea Events" }),
    Item=Window:AddTab({ Title="Tab Auto Get Item" }),
    Setting=Window:AddTab({ Title="Tab Settings" }),
    Status=Window:AddTab({ Title="Tab Server" }),
    Stats=Window:AddTab({ Title="Tab Stats" }),
    Player=Window:AddTab({ Title="Tab Local Players" }),
    Teleport=Window:AddTab({ Title="Teleport" }),
    Visual=Window:AddTab({ Title="Blox Fruits Settings Fake" }),
    Fruit=Window:AddTab({ Title="Tab Fruits" }),
...
elseif Lv == 2550 or Lv <= 2574 or SelectMonster == "Serpent Hunter" or SelectArea == 'Tiki Outpost 2' then
Ms = "Serpent Hunter"
...
elseif Lv == 2575 or Lv <= 2600 or SelectMonster == "Skull Slayer" or SelectArea == 'Tiki Outpost 2' then
Ms = "Skull Slayer"
NameQuest = "TikiQuest3"
QuestLv = 2
...
glow.Image = "rbxassetid://75177922589625"
glow.ImageColor3 = Color3.fromRGB(255, 0, 255)
glow.ImageTransparency = 0.5

-- Âm thanh khi nhấn nút
soundClick.Parent = b
soundClick.SoundId = "rbxassetid://17779566040"
soundClick.Volume = 1
...
--- #Thông Báo
Tabs.Info:AddButton({
        Title="Axion Hub Free",
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/ZhGqFS5A")) 
        end
})
Tabs.Info:AddButton({
    Title="Tobii",
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/@AxionHub_Dev"))
    end
})
Tabs.Info:AddButton({
    Title="Facebook",
    ...
    Callback=function()
        setclipboard(tostring("https://m.facebook.com/huyzreal/"))
    end
})
Tabs.Info:AddParagraph({
    Title="Script Free By Tobii",
    Content="Chym Bé Nhất Máy Chủ"
})
local executorName
...
Tabs.Info:AddParagraph({
    Title="Client Android Support",
    Content="All Client Android"
})
Tabs.Info:AddParagraph({
    Title="Client Pc Support",
    Content="All Client Pc"
})
...
local ToggleChestBypas = Tabs.Main:AddToggle("ToggleChestBypas", {
    Title = "Farm Chest Bypass [ Inactive ]",
    Description = "",
    Default = false
})
...
local ToggleChestItems = Tabs.Main:AddToggle("ToggleChestItems", {
    Title = "Stop When Item Is Available",
    Description = "Picking Up Chests Will Automatically Stop When You Get Something",
    Default = false
})
...
local ToggleCollectBerry = Tabs.Main:AddToggle("ToggleCollectBerry", {
    Title = "Berry Farm",
    Description = "Farm Berry And Auto Hop Server",
    Default = false
})
    ...
    while wait() do
        if _G.AutoCollectBerry then
            ...
            if Nearest then
                ...
                Tween2(CFrameTarget)
                Fluent:Notify({
                    Title = "Teleport Berry",
                    Content = "Berry Spawn: " .. tostring(BerryName),
                    Duration = 10
                })
            else
                Hop()
...
local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
    Title = "Select",
    Description = "",
    Values = {"Level", "Level No Quest", "Kill Aura", "Bone", "Cake",},
    Multi = false,
    Default = 1,
})
...
function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        StatusKitsune:SetDesc("Kitusne Island : ✅️")
    else
        StatusKitsune:SetDesc("Kitsune Island : ❌️")
    end
end
spawn(function()
    pcall(function()
...
createToggle("Tìm Đảo Dung Nham", "AutoFindPrehistoric", islandsToDelete.Prehistoric, "PrehistoricIsland", "Prehistoric Spawn")
createToggle("Tìm Đảo Bí Ẩn", "AutoFindMirage", islandsToDelete.Mirage, "MysticIsland", "Mirage Spawn")
createToggle("Tìm Đảo Leviathan", "AutoFindFrozen", islandsToDelete.Frozen, "FrozenDimension", "Fozen Dimensions Spawn")
local AutoComeTikiToggle = Tabs.Sea:AddToggle("AutoComeTiki", {
    Title="Auto Find Boat To Tiki",
    Description="",
    Default=false
})
...
AutoHaki()
     ...
     local TogglePiranha = Tabs.Sea:AddToggle("TogglePiranha", {Title="Attack Piranha",Description="", Default=false })
     ...
     local ToggleShark = Tabs.Sea:AddToggle("ToggleShark", {Title="Attack Shark",Description="", Default=false })
    ...
    local ToggleFishCrew = Tabs.Sea:AddToggle("ToggleFishCrew", {Title="Attack Fish Ship",Description="", Default=false })
    ...
    local ToggleShip = Tabs.Sea:AddToggle("ToggleShip", {Title="Attack Ghost Ship",Description="", Default=false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Sea:AddToggle("ToggleGhostShip", {Title="Attack Shost Ship",Description="",Default=false })
...
if Sea3 then
    ...
    spawn(function()
        pcall(function()
            while wait() do
                StatusMirage:SetDesc("Đảo Bí Ẩn: " .. MirageStatus .. " | Full Moon: " .. FullMoonStatus)
            end
        end)
    end)
    Tabs.Sea:AddButton({
        Title="Fly To High Places",
        Description="",
        Callback=function()
            TweenToHighestPoint()
        end
...
local ToggleTweenGear = Tabs.Sea:AddToggle("ToggleTweenGear", {Title="Teleport Gear",Description="", Default=true })
...
local Togglelockmoon = Tabs.Sea:AddToggle("Togglelockmoon", {
    Title="Look at the Full Moon and Use Race V3",
    Description="",
    Default=false
})
...
if Sea2 then
    local ToggleSwordLengend = Tabs.Item:AddToggle("ToggleSwordLengend", {Title="Buy Legendary Sword",Description="",Default=false })
    ToggleSwordLengend:OnChanged(function(Value)
        ...
        spawn(function()
            while wait() do
                pcall(function()
                    if _G.BuyLengendSword and Triple_A then
...
local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title="Bring Mod",Description="", Default=true})
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remote Damage",Description = "", Default = false })
...
local Input = Tabs.Status:AddInput("Input", {
    ...
    local Toggle = Tabs.Status:AddToggle("MyToggle", {Title="Spam Job ID", Default=false })
...
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title="Mele",Description="", Default=false })
ToggleMelee:OnChanged(function(Value)
    _G.Auto_Stats_Melee=Value
    end)
Options.ToggleMelee:SetValue(false)
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title="Health",Description="", Default=false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title="Fruits",Description="", Default=false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title="Teleport Players", Description="",Default=false })
...
local ToggleNoClip = Tabs.Player:AddToggle("ToggleNoClip", {Title = "Hack Through Wall", Description = "", Default = true })
...
local ToggleRemoveLava = Tabs.Player:AddToggle("ToggleRemoveLava", {Title = "Remote Lava", Description = "", Default = false})
...
local ToggleSpeedRun = Tabs.Player:AddToggle("ToggleSpeedRun", {Title = "Rabbit V3",Description = "", Default = false })
...
Tabs.Player:AddButton({
    Title = "Get Banned",
    Description = "When Someone Reports You = You Get Banned",
    Callback = function()
    
local ReplicatedStorage = game:GetService("ReplicatedStorage")

while true do
    local textToSend = "béo chó gay report t đi haha server tuổi lồn"
...
local ToggleEnablePvp = Tabs.Player:AddToggle("ToggleEnablePvp", {Title="On PVP", Description="",Default=false })
...
local ToggleDropFruit = Tabs.Fruit:AddToggle("ToggleDropFruit", {Title = "Auto Drop Fruits", Default = false })
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title="Auto Store",Description="", Default=true })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title="Random Fruits",Description="", Default=false })
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title="Teleport Fruits",Description="", Default=false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title="Teleport Bypass Fruits",Description="", Default=false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title="Flowers",Description="", Default=false })
...
local ToggleEspRealFruit = Tabs.Fruit:AddToggle("ToggleEspRealFruit", {Title="Esp Real Fruits", Description="", Default=false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title="Get Fruit Under 1 Million Beli",Description="", Default=false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title="Auto Raid Law",Description="Buy Chip And Attack Law", Default=false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title="Complete Trial",Description="", Default=false })
...
local ToggleKillTrial = Tabs.Race:AddToggle("ToggleKillTrial", {Title="Auto Trial", Description="", Default=false})
...
local Mastery = Tabs.Race:AddSection("Train")
local ToggleFarmRace = Tabs.Race:AddToggle("ToggleFarmRace", {Title="Auto Fram Race ( Trian )", Description="", Default=false})
...
local Mastery = Tabs.Shop:AddSection("Full")

Tabs.Shop:AddButton({
    Title="Buy Full Item [ 4 ]",
    Description="",
    Callback=function()
...
local Mastery = Tabs.Misc:AddSection("Exp")
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title="Rejoin", Description="",Default=true })
...
local DracoV4 = Tabs.Sea:AddParagraph({
    Title="Auto Trial Draco V4 ( Error )",
    Content=""
})
...
local ToggleKillAura = Tabs.Sea:AddToggle("ToggleKillAura", {Title="Golems Aura",Description="", Default=false })
